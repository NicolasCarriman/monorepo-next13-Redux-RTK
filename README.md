...
![alt text](assets/screencapture-localhost-3000-dashboard-tasks-2023-06-19-15_10_09)
![alt text](assets/screencapture-localhost-3000-dashboard-2023-06-19-15_09_25)
...
los equipos obtienen una visión clara de las tareas pendientes, asignadas y completadas. Además, pueden colaborar de manera efectiva y desglosar tareas complejas en subtareas manejables. Esto mejora la productividad, la eficiencia y fomenta una comunicación efectiva entre los miembros del equipo.
